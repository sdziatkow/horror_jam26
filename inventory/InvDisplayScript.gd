...
func give_inventory(inv: Inventory):
	...
	_inv = Inventory.new()
	for i in 5:
		_inv.add_item(ItemMaker.rand_item(ItemEnums.ItemType.HEALER))
		_inv.add_item(ItemMaker.rand_item(ItemEnums.ItemType.AMMO))
		_inv.add_item(ItemMaker.rand_item(ItemEnums.ItemType.WEAPON))
